          ...
          <DataTable pageSize={10} columns={[
            ...
            <>
              ...
              <div className="icon-actions">
                <IconButton icon="✎" label="Chỉnh sửa lớp" disabled={row.hasStudents} onClick={() => setEditingClass(row)} />
                <IconButton icon="🗑" label="Xóa lớp" tone="danger" disabled={row.hasStudents} onClick={() => deleteClass(row)} />
              </div>
            </>
          )} />
        </section>
        ...
        <>
          <section className="panel">
            ...
            <DataTable pageSize={4} columns={[
              ...
              <div className="icon-actions">
                <IconButton icon="🔎" label="Xem lớp" onClick={() => setAssignmentGroup(row)} />
              </div>
            )} />
